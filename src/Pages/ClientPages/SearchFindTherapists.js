  ...
  <div className="row">
    <div className="col-lg-10 mx-auto mb-4">
      <div className="section-title text-center ">
        <h3 className="top-c-sep">Search or Find New Therapist</h3>
        ...
        <p class="mb-30 ff-montserrat nearby">Recommendations </p>
          ...
          <div className="job-box d-md-flex align-items-center justify-content-between mb-30">
            ...
            <div className="job-right my-4 flex-shrink-0">
              <a href="#" className="btn d-block w-100 d-sm-inline-block btn-light"><button type="button" className="btn btn-primary">Add Therapist</button></a>
            </div>
          </div>
...
export default SearchFindTherapists;